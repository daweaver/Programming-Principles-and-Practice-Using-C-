...
int main()
{
    Book::Book pp2("1-2-3-4", "Programming:Principles and Practice Using C++", "Bjarne Stroustrup", Genre::nonfiction,  "1963", false);
    ...
    // Book::Book a("11-22-33-44", "Programming in C", "S. Kochan", "2011", false);
    // Book::Book b("11-22-33-45", "C Primer Plus", "S. Prata", "2010", false);
